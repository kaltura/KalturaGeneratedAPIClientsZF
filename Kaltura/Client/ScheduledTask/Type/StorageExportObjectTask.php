 ...
 * @subpackage Client
 */
class Kaltura_Client_ScheduledTask_Type_StorageExportObjectTask extends Kaltura_Client_ScheduledTask_Type_ObjectTask
{
	...
	public function __construct(SimpleXMLElement $xml = null, $jsonObject = null)
	{
		...
		if(!is_null($jsonObject) && isset($jsonObject->storageId))
			$this->storageId = (string)$jsonObject->storageId;
	}
	/**
	 * Storage profile id
	 *
