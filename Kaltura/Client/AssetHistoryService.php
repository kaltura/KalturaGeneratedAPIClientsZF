 ...
 * @subpackage Client
 */
class Kaltura_Client_AssetHistoryService extends Kaltura_Client_ServiceBase
{
	...
	function listAction(Kaltura_Client_Type_AssetHistoryFilter $filter = null, Kaltura_Client_Type_FilterPager $pager = null)
	{
