 ...
 * @subpackage Client
 */
class Kaltura_Client_ChannelService extends Kaltura_Client_ServiceBase
{
	...
	function add(Kaltura_Client_Type_Channel $channel)
	{
		...
		$resultObject = Kaltura_Client_ParseUtils::unmarshalObject($resultXmlObject->result, "KalturaChannel");
		$this->client->validateObjectType($resultObject, "Kaltura_Client_Type_Channel");
		return $resultObject;
	}
	...
	function update($channelId, Kaltura_Client_Type_Channel $channel)
	{
		if ($this->client->isMultiRequest())
			throw $this->client->getKalturaClientException("Action is not supported as part of multi-request.", Kaltura_Client_ClientException::ERROR_ACTION_IN_MULTIREQUEST);
