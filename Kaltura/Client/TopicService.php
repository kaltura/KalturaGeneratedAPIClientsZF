 ...
 * @subpackage Client
 */
class Kaltura_Client_TopicService extends Kaltura_Client_ServiceBase
{
	...
	function get($id)
	{
		...
		$resultXmlObject = new \SimpleXMLElement($resultXml);
		$this->client->checkIfError($resultXmlObject->result);
		$resultObject = Kaltura_Client_ParseUtils::unmarshalObject($resultXmlObject->result, "KalturaTopic");
		$this->client->validateObjectType($resultObject, "Kaltura_Client_Type_Topic");
		return $resultObject;
	}

	function listAction(Kaltura_Client_Type_TopicFilter $filter = null, Kaltura_Client_Type_FilterPager $pager = null)
	{
		if ($this->client->isMultiRequest())
			throw $this->client->getKalturaClientException("Action is not supported as part of multi-request.", Kaltura_Client_ClientException::ERROR_ACTION_IN_MULTIREQUEST);
		...
		$resultXmlObject = new \SimpleXMLElement($resultXml);
		$this->client->checkIfError($resultXmlObject->result);
		$resultObject = Kaltura_Client_ParseUtils::unmarshalObject($resultXmlObject->result, "KalturaTopicListResponse");
		$this->client->validateObjectType($resultObject, "Kaltura_Client_Type_TopicListResponse");
		return $resultObject;
	}
