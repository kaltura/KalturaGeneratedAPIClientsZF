 ...
 * @subpackage Client
 */
class Kaltura_Client_RecommendationProfileService extends Kaltura_Client_ServiceBase
{
	...
	function add(Kaltura_Client_Type_RecommendationProfile $recommendationEngine)
	{
		...
		$resultObject = Kaltura_Client_ParseUtils::unmarshalObject($resultXmlObject->result, "KalturaRecommendationProfile");
		$this->client->validateObjectType($resultObject, "Kaltura_Client_Type_RecommendationProfile");
		return $resultObject;
	}
	...
	function listAction()
	{
		...
		$resultXmlObject = new \SimpleXMLElement($resultXml);
		$this->client->checkIfError($resultXmlObject->result);
		$resultObject = Kaltura_Client_ParseUtils::unmarshalObject($resultXmlObject->result, "KalturaRecommendationProfileListResponse");
		$this->client->validateObjectType($resultObject, "Kaltura_Client_Type_RecommendationProfileListResponse");
		return $resultObject;
	}

	function update($recommendationEngineId, Kaltura_Client_Type_RecommendationProfile $recommendationEngine)
	{
		if ($this->client->isMultiRequest())
			throw $this->client->getKalturaClientException("Action is not supported as part of multi-request.", Kaltura_Client_ClientException::ERROR_ACTION_IN_MULTIREQUEST);
