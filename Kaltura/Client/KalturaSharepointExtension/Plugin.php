...
{
	/**
	 * @var Kaltura_Client_KalturaSharepointExtension_SharepointExtensionService
	 */
	...
	protected function __construct(Kaltura_Client_Client $client)
	{
		...
		$this->sharepointExtension = new Kaltura_Client_KalturaSharepointExtension_SharepointExtensionService($client);
	}
	...
	{
		return new Kaltura_Client_KalturaSharepointExtension_Plugin($client);
	}
