 ...
 * @subpackage Client
 */
abstract class Kaltura_Client_BusinessProcessNotification_Type_BusinessProcessServerBaseFilter extends Kaltura_Client_Type_Filter
{
	...
	public function __construct(SimpleXMLElement $xml = null, $jsonObject = null)
	{
		...
		if(!is_null($xml) && count($xml->dcEqOrNull))
			$this->dcEqOrNull = (int)$xml->dcEqOrNull;
		if(!is_null($jsonObject) && isset($jsonObject->dcEqOrNull))
			$this->dcEqOrNull = (int)$jsonObject->dcEqOrNull;
	}
	/**
	 * 
	 *
	 ...
	 * 
	 *
	 * @var Kaltura_Client_BusinessProcessNotification_Enum_BusinessProcessServerStatus
	 */
	 ...
	 * 
	 *
	 * @var Kaltura_Client_BusinessProcessNotification_Enum_BusinessProcessProvider
	 */
