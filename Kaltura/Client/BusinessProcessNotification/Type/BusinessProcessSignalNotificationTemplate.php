 ...
 * @subpackage Client
 */
class Kaltura_Client_BusinessProcessNotification_Type_BusinessProcessSignalNotificationTemplate extends Kaltura_Client_BusinessProcessNotification_Type_BusinessProcessNotificationTemplate
{
	...
	public function __construct(SimpleXMLElement $xml = null, $jsonObject = null)
	{
		...
		if(!is_null($jsonObject) && isset($jsonObject->eventId))
			$this->eventId = (string)$jsonObject->eventId;
	}
	/**
