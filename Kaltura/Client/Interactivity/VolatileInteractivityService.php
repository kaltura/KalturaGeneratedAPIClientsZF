 ...
 * @subpackage Client
 */
class Kaltura_Client_Interactivity_VolatileInteractivityService extends Kaltura_Client_ServiceBase
{
	...
	/**
	 * @return Kaltura_Client_Interactivity_Type_VolatileInteractivity
	 * @throws Kaltura_Client_Exception|Kaltura_Client_ClientException
	 */
	function add($entryId, Kaltura_Client_Interactivity_Type_VolatileInteractivity $kalturaVolatileInteractivity)
	{
		$kparams = array();
	 ...
	 * @throws Kaltura_Client_Exception|Kaltura_Client_ClientException
	 */
	function update($entryId, $version, Kaltura_Client_Interactivity_Type_VolatileInteractivity $kalturaVolatileInteractivity)
	{
		$kparams = array();
		$this->client->addParam($kparams, "entryId", $entryId);
