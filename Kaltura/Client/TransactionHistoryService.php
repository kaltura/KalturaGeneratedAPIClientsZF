 ...
 * @subpackage Client
 */
class Kaltura_Client_TransactionHistoryService extends Kaltura_Client_ServiceBase
{
	...
	function listAction(Kaltura_Client_Type_TransactionHistoryFilter $filter = null, Kaltura_Client_Type_FilterPager $pager = null)
	{
