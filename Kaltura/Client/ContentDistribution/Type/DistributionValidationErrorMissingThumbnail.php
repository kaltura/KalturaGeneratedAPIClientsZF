...
class Kaltura_Client_ContentDistribution_Type_DistributionValidationErrorMissingThumbnail extends Kaltura_Client_ContentDistribution_Type_DistributionValidationError
{
	...
	public function __construct(SimpleXMLElement $xml = null, $jsonObject = null)
	{
		...
		if(!is_null($xml) && count($xml->dimensions) && !empty($xml->dimensions))
			$this->dimensions = Kaltura_Client_ParseUtils::unmarshalObject($xml->dimensions, "KalturaDistributionThumbDimensions");
		if(!is_null($jsonObject) && isset($jsonObject->dimensions) && !empty($jsonObject->dimensions))
			$this->dimensions = Kaltura_Client_ParseUtils::jsObjectToClientObject($jsonObject->dimensions, "KalturaDistributionThumbDimensions");
	}
	/**
	 * 
	 *
