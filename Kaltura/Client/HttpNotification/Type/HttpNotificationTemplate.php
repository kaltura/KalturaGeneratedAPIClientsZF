...
class Kaltura_Client_HttpNotification_Type_HttpNotificationTemplate extends Kaltura_Client_EventNotification_Type_EventNotificationTemplate
{
	...
	public function __construct(SimpleXMLElement $xml = null, $jsonObject = null)
	{
		...
		if(!is_null($jsonObject) && isset($jsonObject->data) && !empty($jsonObject->data))
			$this->data = Kaltura_Client_ParseUtils::jsObjectToClientObject($jsonObject->data, "KalturaHttpNotificationData");
		...
		if(!is_null($xml) && count($xml->secureHashingAlgo))
			$this->secureHashingAlgo = (int)$xml->secureHashingAlgo;
		if(!is_null($jsonObject) && isset($jsonObject->secureHashingAlgo))
			$this->secureHashingAlgo = (int)$jsonObject->secureHashingAlgo;
	}
	/**
	 * Remote server URL
	 *
	 ...
	 *
	 * @var Kaltura_Client_HttpNotification_Enum_SecureHashingAlgo
	 */
