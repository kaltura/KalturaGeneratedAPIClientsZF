...
class Kaltura_Client_Audit_Type_AuditTrailChangeInfo extends Kaltura_Client_Audit_Type_AuditTrailInfo
{
	...
	public function __construct(SimpleXMLElement $xml = null, $jsonObject = null)
	{
		...
		if(!is_null($xml) && count($xml->changedItems))
		{
		...
		if(!is_null($jsonObject) && isset($jsonObject->changedItems))
		{
			if(empty($jsonObject->changedItems))
				$this->changedItems = array();
			else
				$this->changedItems = Kaltura_Client_ParseUtils::jsObjectToClientObject($jsonObject->changedItems, "KalturaAuditTrailChangeItem");
		}
	}
	/**
	 * 
