 ...
 * @subpackage Client
 */
class Kaltura_Client_Vendor_VendorIntegrationService extends Kaltura_Client_ServiceBase
{
	 ...
	 */
	function add(Kaltura_Client_Vendor_Type_IntegrationSetting $integration, $remoteId)
	{
		$kparams = array();
	 ...
	 * @throws Kaltura_Client_Exception|Kaltura_Client_ClientException
	 */
	function update($id, Kaltura_Client_Vendor_Type_IntegrationSetting $integrationSetting)
	{
		$kparams = array();
