 ...
 * @subpackage Client
 */
class Kaltura_Client_Vendor_Plugin extends Kaltura_Client_Plugin
{
	/**
	 * @var Kaltura_Client_Vendor_ZoomVendorService
	 */
	...
	/**
	 * @return Kaltura_Client_Vendor_Plugin
	 */
	public static function get(Kaltura_Client_Client $client)
	{
		return new Kaltura_Client_Vendor_Plugin($client);
	}
