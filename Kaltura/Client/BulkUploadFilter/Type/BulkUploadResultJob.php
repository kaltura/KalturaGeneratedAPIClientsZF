 ...
 * @subpackage Client
 */
class Kaltura_Client_BulkUploadFilter_Type_BulkUploadResultJob extends Kaltura_Client_Type_BulkUploadResult
{
	...
	public function __construct(SimpleXMLElement $xml = null, $jsonObject = null)
	{
		...
		if(!is_null($jsonObject) && isset($jsonObject->jobObjectId))
			$this->jobObjectId = (int)$jsonObject->jobObjectId;
	}
	/**
