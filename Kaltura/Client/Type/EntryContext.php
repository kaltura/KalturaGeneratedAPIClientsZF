...
class Kaltura_Client_Type_EntryContext extends Kaltura_Client_Type_Context
{
	...
	public function __construct(SimpleXMLElement $xml = null, $jsonObject = null)
	{
		...
		if(!is_null($xml) && count($xml->followEntryRedirect))
			$this->followEntryRedirect = (int)$xml->followEntryRedirect;
		if(!is_null($jsonObject) && isset($jsonObject->followEntryRedirect))
			$this->followEntryRedirect = (int)$jsonObject->followEntryRedirect;
	}
	/**
