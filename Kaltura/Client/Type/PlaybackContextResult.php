 ...
 * @subpackage Client
 */
class Kaltura_Client_Type_PlaybackContextResult extends Kaltura_Client_ObjectBase
{
	...
	public function __construct(SimpleXMLElement $xml = null)
	{
		...
		if(count($xml->restrictions))
		{
			if(empty($xml->restrictions))
				...
				$this->restrictions = Kaltura_Client_ParseUtils::unmarshalArray($xml->restrictions, "KalturaPlaybackRestriction");
		}
	}
	/**
	 * 
