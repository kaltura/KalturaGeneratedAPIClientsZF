...
abstract class Kaltura_Client_Type_AppTokenBaseFilter extends Kaltura_Client_Type_Filter
{
	...
	public function __construct(SimpleXMLElement $xml = null, $jsonObject = null)
	{
		...
		if(!is_null($xml) && count($xml->sessionUserIdEqual))
			$this->sessionUserIdEqual = (string)$xml->sessionUserIdEqual;
		if(!is_null($jsonObject) && isset($jsonObject->sessionUserIdEqual))
			$this->sessionUserIdEqual = (string)$jsonObject->sessionUserIdEqual;
	}
	/**
	 * 
	 *
