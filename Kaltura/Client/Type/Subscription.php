	...
	public function __construct(SimpleXMLElement $xml = null)
	{
		...
		if(count($xml->names))
		{
			if(empty($xml->names))
				...
				$this->names = Kaltura_Client_ParseUtils::unmarshalArray($xml->names, "KalturaTranslationToken");
		}
		...
		if(count($xml->pricePlans))
		{
			if(empty($xml->pricePlans))
				...
				$this->pricePlans = Kaltura_Client_ParseUtils::unmarshalArray($xml->pricePlans, "KalturaPricePlan");
		}
