...
abstract class Kaltura_Client_Type_EntryServerNode extends Kaltura_Client_ObjectBase
{
	...
	public function __construct(SimpleXMLElement $xml = null, $jsonObject = null)
	{
		...
		if(!is_null($xml) && count($xml->serverNodeId))
			$this->serverNodeId = (int)$xml->serverNodeId;
		if(!is_null($jsonObject) && isset($jsonObject->serverNodeId))
			$this->serverNodeId = (int)$jsonObject->serverNodeId;
		...
		if(!is_null($xml) && count($xml->serverType))
			$this->serverType = (string)$xml->serverType;
		if(!is_null($jsonObject) && isset($jsonObject->serverType))
			$this->serverType = (string)$jsonObject->serverType;
	}
	/**
