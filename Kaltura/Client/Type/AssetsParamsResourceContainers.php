	...
	public function __construct(SimpleXMLElement $xml = null, $jsonObject = null)
	{
		...
		if(!is_null($jsonObject) && isset($jsonObject->resources))
		{
			if(empty($jsonObject->resources))
				...
				$this->resources = Kaltura_Client_ParseUtils::jsObjectToClientObject($jsonObject->resources, "KalturaAssetParamsResourceContainer");
		}
	}
	/**
	 * Array of resources associated with asset params ids
	 *
	 * @var Kaltura_Client_Type_AssetParamsResourceContainer[]
	 */
	public $resources;
