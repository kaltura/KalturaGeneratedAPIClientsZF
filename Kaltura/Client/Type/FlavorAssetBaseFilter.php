...
abstract class Kaltura_Client_Type_FlavorAssetBaseFilter extends Kaltura_Client_Type_AssetFilter
{
	...
	public function __construct(SimpleXMLElement $xml = null, $jsonObject = null)
	{
		...
		if(!is_null($xml) && count($xml->flavorParamsIdIn))
			$this->flavorParamsIdIn = (string)$xml->flavorParamsIdIn;
		if(!is_null($jsonObject) && isset($jsonObject->flavorParamsIdIn))
			$this->flavorParamsIdIn = (string)$jsonObject->flavorParamsIdIn;
