...
abstract class Kaltura_Client_Type_StorageProfileBaseFilter extends Kaltura_Client_Type_Filter
{
	...
	public function __construct(SimpleXMLElement $xml = null, $jsonObject = null)
	{
		...
		if(!is_null($xml) && count($xml->protocolEqual))
			$this->protocolEqual = (string)$xml->protocolEqual;
		if(!is_null($jsonObject) && isset($jsonObject->protocolEqual))
			$this->protocolEqual = (string)$jsonObject->protocolEqual;
		if(!is_null($xml) && count($xml->protocolIn))
			$this->protocolIn = (string)$xml->protocolIn;
		if(!is_null($jsonObject) && isset($jsonObject->protocolIn))
			$this->protocolIn = (string)$jsonObject->protocolIn;
	}
	/**
	 * 
	 *
