 ...
 * @subpackage Client
 */
abstract class Kaltura_Client_Type_DeliveryProfileBaseFilter extends Kaltura_Client_Type_Filter
{
	...
	public function __construct(SimpleXMLElement $xml = null, $jsonObject = null)
	{
		...
		if(!is_null($xml) && count($xml->streamerTypeEqual))
			$this->streamerTypeEqual = (string)$xml->streamerTypeEqual;
		if(!is_null($jsonObject) && isset($jsonObject->streamerTypeEqual))
			$this->streamerTypeEqual = (string)$jsonObject->streamerTypeEqual;
