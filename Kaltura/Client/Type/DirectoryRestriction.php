...
class Kaltura_Client_Type_DirectoryRestriction extends Kaltura_Client_Type_BaseRestriction
{
	...
	public function __construct(SimpleXMLElement $xml = null, $jsonObject = null)
	{
		...
		if(!is_null($xml) && count($xml->directoryRestrictionType))
			$this->directoryRestrictionType = (int)$xml->directoryRestrictionType;
		if(!is_null($jsonObject) && isset($jsonObject->directoryRestrictionType))
			$this->directoryRestrictionType = (int)$jsonObject->directoryRestrictionType;
	}
	/**
