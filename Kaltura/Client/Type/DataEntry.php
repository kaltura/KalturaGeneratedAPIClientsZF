...
class Kaltura_Client_Type_DataEntry extends Kaltura_Client_Type_BaseEntry
{
	...
	public function __construct(SimpleXMLElement $xml = null, $jsonObject = null)
	{
		...
		if(!is_null($xml) && count($xml->retrieveDataContentByGet))
		{
		...
		if(!is_null($jsonObject) && isset($jsonObject->retrieveDataContentByGet))
		{
			if(!empty($jsonObject->retrieveDataContentByGet) && ((int) $jsonObject->retrieveDataContentByGet === 1 || strtolower((string)$jsonObject->retrieveDataContentByGet) === 'true'))
				$this->retrieveDataContentByGet = true;
			else
				$this->retrieveDataContentByGet = false;
		}
