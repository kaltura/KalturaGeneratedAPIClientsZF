...
class Kaltura_Client_Type_BatchJobFilterExt extends Kaltura_Client_Type_BatchJobFilter
{
	...
	public function __construct(SimpleXMLElement $xml = null, $jsonObject = null)
	{
		...
		if(!is_null($xml) && count($xml->jobTypeAndSubTypeIn))
			$this->jobTypeAndSubTypeIn = (string)$xml->jobTypeAndSubTypeIn;
		if(!is_null($jsonObject) && isset($jsonObject->jobTypeAndSubTypeIn))
			$this->jobTypeAndSubTypeIn = (string)$jsonObject->jobTypeAndSubTypeIn;
	}
	/**
	 * 
	 *
