 ...
 * @subpackage Client
 */
class Kaltura_Client_Type_DeliveryProfileLivePackager extends Kaltura_Client_Type_DeliveryProfile
{
	...
	public function __construct(SimpleXMLElement $xml = null, $jsonObject = null)
	{
		...
		if(!is_null($xml) && count($xml->livePackagerSigningDomain))
			$this->livePackagerSigningDomain = (string)$xml->livePackagerSigningDomain;
		if(!is_null($jsonObject) && isset($jsonObject->livePackagerSigningDomain))
			$this->livePackagerSigningDomain = (string)$jsonObject->livePackagerSigningDomain;
