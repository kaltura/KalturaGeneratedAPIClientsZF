 ...
 * @subpackage Client
 */
class Kaltura_Client_Type_ClipDescription extends Kaltura_Client_ObjectBase
{
	...
	public function __construct(SimpleXMLElement $xml = null, $jsonObject = null)
	{
		...
		if(!is_null($xml) && count($xml->offsetInDestination))
			$this->offsetInDestination = (int)$xml->offsetInDestination;
		if(!is_null($jsonObject) && isset($jsonObject->offsetInDestination))
			$this->offsetInDestination = (int)$jsonObject->offsetInDestination;
	}
	/**
	 * 
	 *
