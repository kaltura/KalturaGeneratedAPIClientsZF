 ...
 * @subpackage Client
 */
abstract class Kaltura_Client_Type_AssetParamsBaseFilter extends Kaltura_Client_Type_RelatedFilter
{
	...
	public function __construct(SimpleXMLElement $xml = null, $jsonObject = null)
	{
		...
		if(!is_null($xml) && count($xml->isSystemDefaultEqual))
			$this->isSystemDefaultEqual = (int)$xml->isSystemDefaultEqual;
		if(!is_null($jsonObject) && isset($jsonObject->isSystemDefaultEqual))
			$this->isSystemDefaultEqual = (int)$jsonObject->isSystemDefaultEqual;
		if(!is_null($xml) && count($xml->tagsEqual))
			$this->tagsEqual = (string)$xml->tagsEqual;
		if(!is_null($jsonObject) && isset($jsonObject->tagsEqual))
			$this->tagsEqual = (string)$jsonObject->tagsEqual;
	}
	/**
	 * 
	 *
