...
class Kaltura_Client_EmailNotification_Type_EmailNotificationStaticRecipientProvider extends Kaltura_Client_EmailNotification_Type_EmailNotificationRecipientProvider
{
	...
	public function __construct(SimpleXMLElement $xml = null, $jsonObject = null)
	{
		...
		{
			if(empty($jsonObject->emailRecipients))
				$this->emailRecipients = array();
			else
				$this->emailRecipients = Kaltura_Client_ParseUtils::jsObjectToClientObject($jsonObject->emailRecipients, "KalturaEmailNotificationRecipient");
		}
	}
	/**
