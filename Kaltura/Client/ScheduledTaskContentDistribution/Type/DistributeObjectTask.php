 ...
 * @subpackage Client
 */
class Kaltura_Client_ScheduledTaskContentDistribution_Type_DistributeObjectTask extends Kaltura_Client_ScheduledTask_Type_ObjectTask
{
	...
	public function __construct(SimpleXMLElement $xml = null, $jsonObject = null)
	{
		...
		if(!is_null($jsonObject) && isset($jsonObject->distributionProfileId))
			$this->distributionProfileId = (string)$jsonObject->distributionProfileId;
	}
	/**
