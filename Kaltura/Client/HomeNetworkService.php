 ...
 * @subpackage Client
 */
class Kaltura_Client_HomeNetworkService extends Kaltura_Client_ServiceBase
{
	...
	function add(Kaltura_Client_Type_HomeNetwork $homeNetwork)
	{
		...
		$resultObject = Kaltura_Client_ParseUtils::unmarshalObject($resultXmlObject->result, "KalturaHomeNetwork");
		$this->client->validateObjectType($resultObject, "Kaltura_Client_Type_HomeNetwork");
		return $resultObject;
	}
	...
	function listAction()
	{
		...
		$resultXmlObject = new \SimpleXMLElement($resultXml);
		$this->client->checkIfError($resultXmlObject->result);
		$resultObject = Kaltura_Client_ParseUtils::unmarshalObject($resultXmlObject->result, "KalturaHomeNetworkListResponse");
		$this->client->validateObjectType($resultObject, "Kaltura_Client_Type_HomeNetworkListResponse");
		return $resultObject;
	}

	function update($externalId, Kaltura_Client_Type_HomeNetwork $homeNetwork)
	{
		if ($this->client->isMultiRequest())
			throw $this->client->getKalturaClientException("Action is not supported as part of multi-request.", Kaltura_Client_ClientException::ERROR_ACTION_IN_MULTIREQUEST);
