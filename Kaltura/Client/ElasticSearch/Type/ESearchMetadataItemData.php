 ...
 * @subpackage Client
 */
class Kaltura_Client_ElasticSearch_Type_ESearchMetadataItemData extends Kaltura_Client_ElasticSearch_Type_ESearchItemData
{
	...
	public function __construct(SimpleXMLElement $xml = null, $jsonObject = null)
	{
		...
		if(!is_null($xml) && count($xml->valueText))
			$this->valueText = (string)$xml->valueText;
		if(!is_null($jsonObject) && isset($jsonObject->valueText))
			$this->valueText = (string)$jsonObject->valueText;
		if(!is_null($xml) && count($xml->valueInt))
			$this->valueInt = (int)$xml->valueInt;
		if(!is_null($jsonObject) && isset($jsonObject->valueInt))
			$this->valueInt = (int)$jsonObject->valueInt;
	}
	/**
	 * 
	 *
