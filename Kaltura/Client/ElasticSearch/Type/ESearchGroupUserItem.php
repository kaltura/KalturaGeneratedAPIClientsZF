 ...
 * @subpackage Client
 */
class Kaltura_Client_ElasticSearch_Type_ESearchGroupUserItem extends Kaltura_Client_ElasticSearch_Type_ESearchAbstractUserItem
{
	 ...
	 * 
	 *
	 * @var Kaltura_Client_ElasticSearch_Enum_EsearchGroupUserFieldName
	 */
