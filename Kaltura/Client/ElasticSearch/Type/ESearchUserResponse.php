	...
	public function __construct(SimpleXMLElement $xml = null, $jsonObject = null)
	{
		...
		if(!is_null($jsonObject) && isset($jsonObject->objects))
		{
			if(empty($jsonObject->objects))
				...
				$this->objects = Kaltura_Client_ParseUtils::jsObjectToClientObject($jsonObject->objects, "KalturaESearchUserResult");
		}
	}
	/**
	 * 
	 *
	 * @var Kaltura_Client_ElasticSearch_Type_ESearchUserResult[]
	 * @readonly
	 */
	public $objects;
