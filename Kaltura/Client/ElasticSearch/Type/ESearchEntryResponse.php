 ...
 * @subpackage Client
 */
class Kaltura_Client_ElasticSearch_Type_ESearchEntryResponse extends Kaltura_Client_ElasticSearch_Type_ESearchResponse
{
	...
	public function __construct(SimpleXMLElement $xml = null, $jsonObject = null)
	{
		...
		if(!is_null($jsonObject) && isset($jsonObject->objects))
		{
			if(empty($jsonObject->objects))
				...
				$this->objects = Kaltura_Client_ParseUtils::jsObjectToClientObject($jsonObject->objects, "KalturaESearchEntryResult");
		}
