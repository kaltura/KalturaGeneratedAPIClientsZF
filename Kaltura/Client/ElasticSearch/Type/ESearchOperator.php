 ...
 * @subpackage Client
 */
class Kaltura_Client_ElasticSearch_Type_ESearchOperator extends Kaltura_Client_ElasticSearch_Type_ESearchBaseItem
{
	...
	public function __construct(SimpleXMLElement $xml = null)
	{
		...
		if(count($xml->searchItems))
		{
			if(empty($xml->searchItems))
				...
				$this->searchItems = Kaltura_Client_ParseUtils::unmarshalArray($xml->searchItems, "KalturaESearchBaseItem");
		}
	}
	/**
	 * 
