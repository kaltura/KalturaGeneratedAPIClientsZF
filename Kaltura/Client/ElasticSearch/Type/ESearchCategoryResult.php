 ...
 * @subpackage Client
 */
class Kaltura_Client_ElasticSearch_Type_ESearchCategoryResult extends Kaltura_Client_ElasticSearch_Type_ESearchResult
{
	...
	public function __construct(SimpleXMLElement $xml = null, $jsonObject = null)
	{
		...
		if(!is_null($jsonObject) && isset($jsonObject->object) && !empty($jsonObject->object))
			$this->object = Kaltura_Client_ParseUtils::jsObjectToClientObject($jsonObject->object, "KalturaCategory");
	}
	/**
	 * 
	 *
