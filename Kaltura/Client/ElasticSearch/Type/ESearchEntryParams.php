 ...
 * @subpackage Client
 */
class Kaltura_Client_ElasticSearch_Type_ESearchEntryParams extends Kaltura_Client_ElasticSearch_Type_ESearchParams
{
	...
	public function __construct(SimpleXMLElement $xml = null, $jsonObject = null)
	{
		...
		if(!is_null($jsonObject) && isset($jsonObject->searchOperator) && !empty($jsonObject->searchOperator))
			$this->searchOperator = Kaltura_Client_ParseUtils::jsObjectToClientObject($jsonObject->searchOperator, "KalturaESearchEntryOperator");
		...
		if(!is_null($jsonObject) && isset($jsonObject->aggregations) && !empty($jsonObject->aggregations))
			$this->aggregations = Kaltura_Client_ParseUtils::jsObjectToClientObject($jsonObject->aggregations, "KalturaESearchAggregation");
	}
	/**
	 * 
	 *
