 ...
 * @subpackage Client
 */
class Kaltura_Client_ElasticSearch_Type_ESearchGroupParams extends Kaltura_Client_ElasticSearch_Type_ESearchParams
{
	 ...
	 * 
	 *
	 * @var Kaltura_Client_ElasticSearch_Type_ESearchGroupOperator
	 */
