...
class Kaltura_Client_ShortLink_Type_ShortLink extends Kaltura_Client_ObjectBase
{
	...
	public function __construct(SimpleXMLElement $xml = null, $jsonObject = null)
	{
		...
		if(!is_null($xml) && count($xml->expiresAt))
			$this->expiresAt = (int)$xml->expiresAt;
		if(!is_null($jsonObject) && isset($jsonObject->expiresAt))
			$this->expiresAt = (int)$jsonObject->expiresAt;
		...
		if(!is_null($xml) && count($xml->fullUrl))
