 ...
 * @subpackage Client
 */
class Kaltura_Client_Room_Type_RoomEntry extends Kaltura_Client_Type_BaseEntry
{
	...
	public function __construct(SimpleXMLElement $xml = null, $jsonObject = null)
	{
		...
		if(!is_null($xml) && count($xml->roomType))
			$this->roomType = (int)$xml->roomType;
		if(!is_null($jsonObject) && isset($jsonObject->roomType))
			$this->roomType = (int)$jsonObject->roomType;
		if(!is_null($xml) && count($xml->broadcastEntryId))
			$this->broadcastEntryId = (string)$xml->broadcastEntryId;
		if(!is_null($jsonObject) && isset($jsonObject->broadcastEntryId))
			$this->broadcastEntryId = (string)$jsonObject->broadcastEntryId;
		if(!is_null($xml) && count($xml->templateRoomEntryId))
	 ...
	 * 
	 *
	 * @var Kaltura_Client_Room_Enum_RoomType
	 */
