 ...
 * @subpackage Client
 */
class Kaltura_Client_Room_RoomService extends Kaltura_Client_ServiceBase
{
	...
	/**
	 * @return Kaltura_Client_Room_Type_RoomEntry
	 * @throws Kaltura_Client_Exception|Kaltura_Client_ClientException
	 */
	function add(Kaltura_Client_Room_Type_RoomEntry $entry)
	{
		$kparams = array();
		...
		if ($this->client->getConfig()->format === Kaltura_Client_ClientBase::KALTURA_SERVICE_FORMAT_JSON) {
			...
			$resultObject = Kaltura_Client_ParseUtils::unmarshalObject($resultXmlObject->result, "KalturaRoomEntry");
			$this->client->validateObjectType($resultObject, "Kaltura_Client_Room_Type_RoomEntry");
		}
			return $resultObject;
	}
	...
	/**
	 * @return Kaltura_Client_Room_Type_RoomEntryListResponse
	 * @throws Kaltura_Client_Exception|Kaltura_Client_ClientException
	 */
	function listAction(Kaltura_Client_Room_Type_RoomEntryFilter $filter = null, Kaltura_Client_Type_FilterPager $pager = null)
	{
		$kparams = array();
		if ($filter !== null)
		...
		if ($this->client->getConfig()->format === Kaltura_Client_ClientBase::KALTURA_SERVICE_FORMAT_JSON) {
			...
			$resultXmlObject = new \SimpleXMLElement($rawResult);
			$this->client->checkIfError($resultXmlObject->result);
			$resultObject = Kaltura_Client_ParseUtils::unmarshalObject($resultXmlObject->result, "KalturaRoomEntryListResponse");
			$this->client->validateObjectType($resultObject, "Kaltura_Client_Room_Type_RoomEntryListResponse");
		}
			return $resultObject;
	}
	 ...
	 * @throws Kaltura_Client_Exception|Kaltura_Client_ClientException
	 */
	function update($roomId, Kaltura_Client_Room_Type_RoomEntry $room)
	{
		$kparams = array();
		$this->client->addParam($kparams, "roomId", $roomId);
