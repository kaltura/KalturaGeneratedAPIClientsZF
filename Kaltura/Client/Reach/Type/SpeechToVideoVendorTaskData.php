 ...
 * @subpackage Client
 */
class Kaltura_Client_Reach_Type_SpeechToVideoVendorTaskData extends Kaltura_Client_Reach_Type_VendorTaskData
{
	...
	public function __construct(SimpleXMLElement $xml = null, $jsonObject = null)
	{
		...
		if(!is_null($xml) && count($xml->avatarId))
			$this->avatarId = (string)$xml->avatarId;
		if(!is_null($jsonObject) && isset($jsonObject->avatarId))
			$this->avatarId = (string)$jsonObject->avatarId;
