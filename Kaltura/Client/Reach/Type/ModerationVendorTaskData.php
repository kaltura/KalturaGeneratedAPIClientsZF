 ...
 * @subpackage Client
 */
class Kaltura_Client_Reach_Type_ModerationVendorTaskData extends Kaltura_Client_Reach_Type_VendorTaskData
{
	...
	public function __construct(SimpleXMLElement $xml = null, $jsonObject = null)
	{
		...
		if(!is_null($xml) && count($xml->ruleIds))
			$this->ruleIds = (string)$xml->ruleIds;
		if(!is_null($jsonObject) && isset($jsonObject->ruleIds))
			$this->ruleIds = (string)$jsonObject->ruleIds;
		if(!is_null($xml) && count($xml->policyIds))
		...
		if(!is_null($jsonObject) && isset($jsonObject->moderationOutputJson))
			$this->moderationOutputJson = (string)$jsonObject->moderationOutputJson;
	}
	/**
