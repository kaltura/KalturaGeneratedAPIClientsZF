 ...
 * @subpackage Client
 */
class Kaltura_Client_SystemPartner_Type_SystemPartnerUsageListResponse extends Kaltura_Client_Type_ListResponse
{
	...
	public function __construct(SimpleXMLElement $xml = null, $jsonObject = null)
	{
		...
		if(!is_null($jsonObject) && isset($jsonObject->objects))
		{
			if(empty($jsonObject->objects))
				...
				$this->objects = Kaltura_Client_ParseUtils::jsObjectToClientObject($jsonObject->objects, "KalturaSystemPartnerUsageItem");
		}
	}
	/**
	 * 
