...
abstract class Kaltura_Client_VirusScan_Type_VirusScanProfileBaseFilter extends Kaltura_Client_Type_Filter
{
	...
	public function __construct(SimpleXMLElement $xml = null, $jsonObject = null)
	{
		...
		if(!is_null($xml) && count($xml->engineTypeEqual))
			$this->engineTypeEqual = (string)$xml->engineTypeEqual;
		if(!is_null($jsonObject) && isset($jsonObject->engineTypeEqual))
			$this->engineTypeEqual = (string)$jsonObject->engineTypeEqual;
		if(!is_null($xml) && count($xml->engineTypeIn))
			$this->engineTypeIn = (string)$xml->engineTypeIn;
		if(!is_null($jsonObject) && isset($jsonObject->engineTypeIn))
			$this->engineTypeIn = (string)$jsonObject->engineTypeIn;
	}
	/**
	 * 
	 *
