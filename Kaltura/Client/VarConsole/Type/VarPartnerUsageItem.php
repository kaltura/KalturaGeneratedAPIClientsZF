...
class Kaltura_Client_VarConsole_Type_VarPartnerUsageItem extends Kaltura_Client_ObjectBase
{
	...
	public function __construct(SimpleXMLElement $xml = null, $jsonObject = null)
	{
		...
		if(!is_null($xml) && count($xml->combinedStorageBandwidth))
			$this->combinedStorageBandwidth = (float)$xml->combinedStorageBandwidth;
		if(!is_null($jsonObject) && isset($jsonObject->combinedStorageBandwidth))
			$this->combinedStorageBandwidth = (float)$jsonObject->combinedStorageBandwidth;
		...
		if(!is_null($xml) && count($xml->dateId))
			$this->dateId = (string)$xml->dateId;
		if(!is_null($jsonObject) && isset($jsonObject->dateId))
			$this->dateId = (string)$jsonObject->dateId;
	}
	/**
	 * Partner ID
	 *
