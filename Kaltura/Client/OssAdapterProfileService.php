 ...
 * @subpackage Client
 */
class Kaltura_Client_OssAdapterProfileService extends Kaltura_Client_ServiceBase
{
	...
	function add(Kaltura_Client_Type_OSSAdapterProfile $ossAdapter)
	{
		...
		$resultObject = Kaltura_Client_ParseUtils::unmarshalObject($resultXmlObject->result, "KalturaOSSAdapterProfile");
		$this->client->validateObjectType($resultObject, "Kaltura_Client_Type_OSSAdapterProfile");
		return $resultObject;
	}
	...
	function update($ossAdapterId, Kaltura_Client_Type_OSSAdapterProfile $ossAdapter)
	{
		if ($this->client->isMultiRequest())
			throw $this->client->getKalturaClientException("Action is not supported as part of multi-request.", Kaltura_Client_ClientException::ERROR_ACTION_IN_MULTIREQUEST);
