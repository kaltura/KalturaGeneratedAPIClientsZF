 ...
 * @subpackage Client
 */
class Kaltura_Client_EntryPermissionLevel_Type_PermissionLevel extends Kaltura_Client_ObjectBase
{
	 ...
	 * Permission Level
	 *
	 * @var Kaltura_Client_EntryPermissionLevel_Enum_UserEntryPermissionLevel
	 */
