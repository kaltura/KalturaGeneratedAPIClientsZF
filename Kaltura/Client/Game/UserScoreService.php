 ...
 * @subpackage Client
 */
class Kaltura_Client_Game_UserScoreService extends Kaltura_Client_ServiceBase
{
	...
	/**
	 * @return Kaltura_Client_Game_Type_UserScorePropertiesResponse
	...
	function delete($gameObjectId, $gameObjectType, $userId)
	{
		...
		if ($this->client->getConfig()->format === Kaltura_Client_ClientBase::KALTURA_SERVICE_FORMAT_JSON) {
			...
			$resultObject = Kaltura_Client_ParseUtils::unmarshalObject($resultXmlObject->result, "KalturaUserScorePropertiesResponse");
			$this->client->validateObjectType($resultObject, "Kaltura_Client_Game_Type_UserScorePropertiesResponse");
		}
			return $resultObject;
	}
	 ...
	 * @throws Kaltura_Client_Exception|Kaltura_Client_ClientException
	 */
	function listAction(Kaltura_Client_Game_Type_UserScorePropertiesFilter $filter, Kaltura_Client_Type_FilterPager $pager = null)
	{
		$kparams = array();
